<div class="">
      <form id="register-form" method="post" action="" >
          <fieldset id="account_information" class="">
            ...
            <div class="form-group ur-form-row-1">
                <label for="email">Comapany Name:</label>
                <input type="text" name="companyname" class="form-control" id="companyname" >
            </div>
            <a class="btn btn-primary next" >Next</a>
          </fieldset>
          <fieldset id="country_information" class="">
            <div class="form-group ur-form-row-2" >
            ...
            <div class="form-group ur-form-row-2" >
                ...
                <select data-rules="" data-id="country" type="text" name="country" id="country" class="form-control" value="" data-label="Country" class="input-text input-text ur-frontend-field td-login-input chosen-select">
            ...
            <div class="form-group">
                <input class="" name="newsletter_check" type="checkbox" id="newsletter_check" value="forever"   /> <span><?php _e( 'Yes, I want to receive emails from TechVersions that may be of interest to me.', 'user-registration-terms' ); ?></span>
            </div>
            <div class="form-group">
            <p><input class="" name="privacy_check" type="checkbox" id="privacy_check" value="forever" required="true" /> 
                I understand by creating an account, I agree to TechVersion's <a class="form-check-a" href="<?php echo site_url('terms-of-service') ?>">Terms of Use</a> and <a class="form-check-a" href="https://anteriad.com/privacy-policy/" target="_blank">Privacy Policy</a> and that I may review and update my marketing preferences at any time. </p>
            ...
            <a class="btn btn-primary" id="previous">Go Back</a>
            <input type="submit" name="usersubmit" value="Register" class="btn btn-primary button-submit" id="register_button">
  ...
  <script>
    ...
    // Enable the submit button by setting the disabled property to false
