	...
	<form method="post" class="user-registration-ResetPassword lost_reset_password">
		<div class="ur-form-row">
			<div class="ur-form-grid">
				<p><?php echo apply_filters( 'user_registration_lost_password_message', __( 'Can’t remember your password? Don’t worry. Please enter your business email address. You will receive a link to reset your password via email.', 'user-registration' ) ); ?></p>

				<p class="user-registration-form-row user-registration-form-row--first form-row form-row-first">
					<label for="user_login"><?php _e( 'Business Email *', 'user-registration' ); ?></label>
