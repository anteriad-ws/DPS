...
class HRD_Adsense_Widget extends WP_Widget { 
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'herald_adsense_widget', 'description' => esc_html__('You can place Google AdSense or any JavaScript related code inside this widget', 'herald-buddy') );
		$control_ops = array( 'id_base' => 'herald_adsense_widget' );
		parent::__construct( 'herald_adsense_widget', esc_html__('Herald Adsense', 'herald-buddy'), $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		<p>
			...
			<small class="howto"><?php esc_html_e('Leave empty for no title', 'herald-buddy'); ?></small>
		</p>
		
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'adsense_code' )); ?>"><?php esc_html_e('Adsense Code', 'herald-buddy'); ?>:</label>
			...
			<small class="howto"><?php esc_html_e('Place your Google Adsense code or any JavaScript related advertising code.', 'herald-buddy'); ?></small>
		</p>
